...
Я работаю инженером-программистом на php.  
Сейчас делаем отчеты различных структур университета в PHP для модуля информационной системы. Есть база данных в Postgres составляем SQL запросы и выводим на страницу.
...
"Расписание занятий". Потом произошло слияние организаций и смена руководства. Теперь основной язык программирования php.
